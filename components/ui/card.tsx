...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "group rounded-2xl border border-white/10 bg-white/[0.02] p-6 shadow-xl shadow-black/20 backdrop-blur",
...
const CardContent = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("space-y-3 text-slate-300", className)} {...props} />
));
